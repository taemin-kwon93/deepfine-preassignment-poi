...
// Insert one row
const insertPoi = (item) =>
  new Promise((resolve, reject) => {
    global.psql.insert('poi', 'insertPoi', item, (cnt) => resolve(cnt), reject);
  });

const insertPoiBulk = (list) =>
  new Promise((resolve, reject) => {
    global.psql.insert('poi', 'insertPoiBulk', { list }, (cnt) => resolve(cnt), reject);
  });
...
exports.importExcel = async (req, res) => {
    ...
    try {
        ...
        const rollback = async () => client.query('ROLLBACK').catch(() => {});
